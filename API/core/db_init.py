...
async def process_new_files(session: Session) -> bool:
    """Check for new images and masks in the dataset and add them to the database.

    Returns:
        bool: True if new files were found and added, False otherwise
    """
...
async def setup_database():
    """Main function to setup or restore database state at application startup."""
