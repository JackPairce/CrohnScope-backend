...
from API.routes import ai, cells, image, mask, monitoring
from API.db.session import engine
from fastapi.middleware.cors import CORSMiddleware
from contextlib import asynccontextmanager

# from API.services.ai.scheduler import scheduler
from API.core.db_init import setup_database
from API.core.init import backup_database
import logging
